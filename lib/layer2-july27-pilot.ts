/**
 * Standalone snapshot of lib/prompts/identity-report.ts's LAYER_2_PROMPT as
 * it stood at commit 4aa0c18 (2026-07-27 18:49:58 +0200) — the version that
 * held from 2026-07-27 through 2026-08-10, before #84/#86(a)/#87, #82, #85,
 * #102, #103, #99, #113, and #112 landed. Byte-identical to
 * `git show 4aa0c18:lib/prompts/identity-report.ts`, confirmed via diff.
 *
 * NOT wired into generateIdentityReport, any API route, or any artifact
 * type — exists only for the July27-vs-Current diagnostic comparison
 * requested against Leona's real evidence. lib/prompts/identity-report.ts
 * itself (the live prompt) is untouched.
 */
export const VARIANT_JULY27_LAYER_2_PROMPT = `You are Zyrro's Layer 2 Report Engine.
